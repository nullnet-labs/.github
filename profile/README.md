...
This application aims to provide a human-curated publicly available Web space for finding and sharing other Web pages online. This is to boost discoverability for the rest of the Web, especially Web spaces that are non-commercial, educational, personal, artistically inspired, or otherwise not optimized for monetization & SEO.
